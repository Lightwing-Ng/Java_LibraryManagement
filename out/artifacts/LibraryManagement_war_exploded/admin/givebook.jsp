...
${requestScope.GiveMsg}
<html:form action="/admin/GiveAction.do" method="POST">
<table>
<tr>
<td>图书编号：<html:text property="books_ID"/></td>
<td>用户名：<html:text property="users_ID"/></td>
<td><html:submit value="返还"/></td>
</tr>
</table>
</html:form>
