...
<center>
  <h1>Admin 登陆</h1>
  <form method="post" action="AdminLoginAction.do">
  <table>
    <tr>
      <td>        用户名:
        <input type="text" name="admin_Name"/><font color="red"><html:errors property="nameerr"/></font>
      </td>
    </tr>
    <tr>
      <td>        密码:
        <input type="password" name="admin_Pwd"/><font color="red"><html:errors property="pwderr"/></font>
      </td>
    </tr>
    <tr>
      <td>
